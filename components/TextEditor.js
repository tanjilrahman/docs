  ...
  return (
    <div className='bg-[#F8F9FA] min-h-screen pb-16'>
      <Editor
        ...
        toolbarClassName='flex sm:sticky sm:top-[67px] z-50 !justify-center mx-auto'
        editorClassName='mt-6 p-5 md:p-20 bg-white shadow-lg max-w-5xl mx-auto mb-12 border'
      />
    </div>
  );
}
